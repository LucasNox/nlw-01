...
const Points = () => {
	...
	const routesParam = routes.params as Params;
	...
	useEffect(()=>{
		api.get('points', {
			params: {
				city: routesParam.selectedCity,
				uf: routesParam.selectedUf,
				items: selectedItems
			}
		}).then(response => {
	...
	useEffect(()=>{
		async function loadPosition() {
			...
			if (status !== 'granted') {
				Alert.alert('Ops negão, precisamos de usa permissão pra obter a localização');
				return;
			}
